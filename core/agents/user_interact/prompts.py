BASE_GUIDANCE = (
    ...
    "• When user requests price optimization, call `optimize_price(sku=...)`\n"
    ...
    "  3. **Runs pricing algorithm** - analyzes competitive pricing and selects optimal algorithm\n"
    "  4. **Validates proposal** - ensures price meets business constraints\n"
    "  5. **Publishes proposal** - makes recommendation available in proposals table\n"
