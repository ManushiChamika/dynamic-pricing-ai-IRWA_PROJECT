...
# ————————————————————————————————————————————————————————————————
st.set_page_config(
    page_title="FluxPricer AI — Welcome",
    page_icon="💹",
    layout="wide",
...
# ————————————————————————————————————————————————————————————————
# Primary Actions (Only Login/Register for Landing Page)
# ————————————————————————————————————————————————————————————————
...
with s1:
    st.markdown('<div class="card metric lift"><div class="kicker">Auth Status</div><h3 style="color: var(--warning)">Guest</h3></div>', unsafe_allow_html=True)
with s2:
