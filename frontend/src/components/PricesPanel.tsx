...
export function PricesPanel() {
  ...
  return (
    <aside
      id="prices-panel"
      className={`fixed inset-y-0 right-0 z-40 transition-all duration-250 ease-in-out motion-reduce:transition-none ${collapsed ? 'w-12 p-2 bg-[rgb(2,8,23)] translate-x-full md:translate-x-0 border-l' : 'w-[280px] p-4 overflow-auto bg-background/0 backdrop-blur-0 border-l border-border/0 translate-x-0'}`}
