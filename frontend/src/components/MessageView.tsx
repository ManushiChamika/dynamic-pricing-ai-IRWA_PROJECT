...
export function MessageView({ m, showModel, showTimestamps, showMeta, allMessages }: { m: Message, showModel: boolean, showTimestamps: boolean, showMeta: boolean, allMessages: Message[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 opacity-70 text-xs flex gap-2 flex-wrap">
        ...
        {showMeta ? (
          <MetadataTooltip message={m as any} />
        ) : null}
