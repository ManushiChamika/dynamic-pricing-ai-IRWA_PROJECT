...
export function PricingPage() {
  ...
  <section className={`px-6 py-24 ${secondarySurface}`}>
          <div className="container mx-auto">
                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className={`text-sm ${helperText}`}>
                          {plan.period}
                        </span>
                      </div>
                    </div>
            ...
            <div className={`mt-16 max-w-3xl mx-auto rounded-2xl border ${isDark ? 'border-white/10 bg-[#1E293B]/50' : 'border-slate-200 bg-white'} p-8 shadow-[0_20px_45px_rgba(15,23,42,0.1)]`}>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className={mutedText}>
                    Yes! Annual plans come with 20% savings. Contact our sales team for enterprise discounts.
                  </p>
                </div>
              </div>
            </div>
